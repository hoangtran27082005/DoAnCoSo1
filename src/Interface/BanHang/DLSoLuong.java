...
public class DLSoLuong extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new ImageIcon(AppConfig.getImageURL("tru(-).png"))); // NOI18N
        ...
        jButton4.setIcon(new ImageIcon(AppConfig.getImageURL("Cong(+).png"))); // NOI18N
        ...
        jLabel4.setIcon(new ImageIcon(AppConfig.getImageURL("thucdon2.png"))); // NOI18N
